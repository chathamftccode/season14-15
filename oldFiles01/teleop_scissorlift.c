...
int motorSpeed = 30; //speed of scissor lift motor
...
task main(){
	while(true){
		while(joy1Btn(7)==1){//read how long trigger were held down
			wait1Msec(10);
			trigger_time_right=trigger_time_right+10;
		}
		while(joy1Btn(8)==1){
			wait1Msec(10);
			trigger_time_left=trigger_time_left+10;
		}
